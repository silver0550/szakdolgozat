        ...
        <x-table class="p-2 bg-base-200 rounded-md ">
            <x-slot name="head">
                ...
                @else
                    ...
                    <x-table.head wire:click="sort('type')" class="cursor-pointer">Típus</x-table.head>
                    <x-table.head wire:click="sort('user')" class="cursor-pointer">Tulajdonosa</x-table.head>
                    <x-table.head wire:click="sort('created_at')" class="cursor-pointer">Létrehozva</x-table.head>
                @endif
            </x-slot>
            <x-slot name='body'>
